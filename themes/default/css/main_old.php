...
body { font-family:"Lato",sans-serif; background:url('<?php echo themes_url('images/bg.png'); ?>'); }
.wrap { float:center; width:100%; height:auto; }
.header { background:url('<?php echo themes_url('images/bg.png'); ?>'); width:auto; overflow:hidden; margin:0; padding:50px 10px 20px 10px; }
.header_body { }
.body { background:url('<?php echo themes_url('images/bg.png'); ?>'); overflow:hidden; }
.cont_body { padding:10px 0 10px 0; background:url('<?php echo themes_url('images/bg.png'); ?>'); border:0; }
.footer { background:url('<?php echo themes_url('images/bg.png'); ?>'); }
