						...
						<div style="float:left; width:48%; padding-right:0.2px;">
							<div style="width:97%; padding:20px;">
								<?php if($this->session->userdata('admin')): ?>
									<span id="portrait<?php echo $i; ?>" style="color:#fff; font-size:16px; cursor:pointer;">Edit</span>	
									...
									<script>
										document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
											uploadFiles('<?php echo base_url('admin/portrait_cover_reupload/'.$get['photos_id'].'?type='.$get['category'].''); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('portraits'); ?>');
										}, false);
										
										var wed<?php echo $i; ?> = document.getElementById("portrait<?php echo $i; ?>");
								...
								<?php else: ?>
								<?php endif; ?>
								<?php if($get['category'] == 'Family'): ?>
								<a href="<?php echo base_url('portraits/category?type=family'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/portraits/family/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Individual'): ?>
								<a href="<?php echo base_url('portraits/category?type=individual'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/portraits/individual/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Children'): ?>
								<a href="<?php echo base_url('portraits/category?type=children'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/portraits/children/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Pregnancy/Boudair'): ?>
								<a href="<?php echo base_url('portraits/category?type=pregnancy_boudair'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/portraits/pregnancy_boudair/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php else: ?>
								<?php endif; ?>
								<br />
