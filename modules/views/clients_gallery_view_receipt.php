	...
	<div style="margin:0 auto; width:85%; overflow:hidden; color:#ffffff;">
		...
		<table style="width:100%;font-family:Helvetica;">
			...
			<tr style="color:#000;">
				...
				<td colspan="4" style="text-align:right;"><div style="margin-right:5px">Discount:</div></td>
			...
			<tr style="color:#000;">
				...
				<td>$<?php echo number_format(($total_price - $discount) * $tax,2); ?></td>
			...
			<tr style="color:#000;">
				...
				<td>$<?php echo number_format($total_price + (($total_price - $discount) * $tax) + $shipping_cost - $discount,2); ?></td>
