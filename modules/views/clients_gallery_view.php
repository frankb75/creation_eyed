...
<?php
	$query = $this->QModel->sfwa('clients_photos','clients_id',$clients_id,'CAST(clients_photos_id AS DECIMAL(10,2)) ASC');
...
<script type="text/javascript">
	...
	{		
		...
		xmlhttp.open("GET","<?php echo base_url('gallery/clientsImagesLoading/'.$clients_id); ?>",true);
		xmlhttp.send();
	}
