...
<div style="margin-left:auto; font-family:Helvetica; margin-right:auto; width:80%; padding-left:50px; overflow:hidden;">
	<?php $query = $this->QModel->query("SELECT * FROM headshots_photos WHERE category='".$cats."' ORDER BY photos_id ASC"); ?>
	<?php if($type == "adult"): ?>
		<?php
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="adult<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					...
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=adult'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('headshots/category?type=adult'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("adult<?php echo $i; ?>");
				...
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/headshots/adult/original/'.$photos); ?>" rel="lightbox[adult]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/headshots/adult/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					...
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=children2'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('headshots/category?type=children2'); ?>');
						}, false);
				...
				<?php endif; ?>
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/headshots/child/original/'.$photos); ?>" rel="lightbox[child]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/headshots/child/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
	...
	<?php elseif($type == "business"): ?>
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="business<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					<form name="uploading<?php echo $i; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
						<input id="u<?php echo $i; ?>" type="file" name="upload" style="width:200px; opacity:0"/>
					</form>
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=business'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('headshots/category?type=business'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("business<?php echo $i; ?>");
						wed<?php echo $i; ?>.onclick = function(event) {
							document.uploading<?php echo $i; ?>.upload.click(event);
						};
					</script>
				...
				<?php endif; ?>
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/headshots/business/original/'.$photos); ?>" rel="lightbox[business]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/headshots/business/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
