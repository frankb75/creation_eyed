			...
			<div class="payment_proccess" style="float:right; width:54%; overflow:hidden;">
				...
				<?php 
...

					{
						...
						$query3 = $this->QModel->sfwa('cart',array('session_id','delivery_setup_id','color','clients_photos_id'),array($this->session->userdata('isCart'),$delivery_setup_id,'BlacknWhite',$clients_photos_id));
