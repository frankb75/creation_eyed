...
<div style="margin-left:auto; margin-right:auto; width:85%; overflow:hidden;">
	<div style="float:left; font-family:Helvetica; margin-bottom:20px; width:100%;">
		<a href="<?php echo base_url(); ?>"><img src="<?php echo themes_url('images/home_icon.png'); ?>" /></a> <img src="<?php echo themes_url('images/arrow_icon.png'); ?>" /> <span style="color:#d4d4d4;font-size:24px;"><?php echo ucwords($this->segment->uri(0)); ?></span>
	</div>
</div>
						...
						<div style="float:left; width:48%; padding-right:0.2px;">
							<div style="width:97%; padding:20px;">
								<?php if($this->session->userdata('admin')): ?>
									<span id="video_cover<?php echo $i; ?>" style="color:#fff; font-size:16px; cursor:pointer;">Edit</span>	
									...
									<script>
										document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
											uploadFiles('<?php echo base_url('admin/video_cover_reupload/'.$get['photos_id'].'?type='.$get['category'].''); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('video'); ?>');
										}, false);
								...
								<a href="<?php echo base_url('video/category?type=weddings'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/video/weddings/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Bar Mitzvahs'): ?>
								<a href="<?php echo base_url('video/category?type=bar_mitzvahs'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/video/bar_mitzvahs/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Celebration of Life'): ?>
								<a href="<?php echo base_url('video/category?type=celebrate_life'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/video/celebration_of_life/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Growing up Montage'): ?>
								<a href="<?php echo base_url('video/category?type=growing_montage'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/video/growing_up_montage/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php elseif($get['category'] == 'Specialty'): ?>
								<a href="<?php echo base_url('video/category?type=specialty'); ?>">
								<img class="img_size" src="<?php echo base_url('uploads/video/specialty/cover/'.$get['photos']) ?>" style="height:400px;" />
								<?php else: ?>
								<?php endif; ?>
								<br />
								<img src="<?php echo themes_url('images/image_icon.png'); ?>"/> <span style="color:#878c94;font-family:Calibri;"><?php echo $get['category']; ?></span>
								<br />
								</a>
							</div>
						</div>
