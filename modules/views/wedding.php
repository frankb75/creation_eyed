...
<div style="margin-left:auto; font-family:Helvetica; margin-right:auto; width:80%; overflow:hidden;">
	<?php 
		$x = 1;
		while($x<=9):
	?>
	<div style="float:left;width:30%;padding-bottom:10px; border:1px solid #fff;">
		<div>
			<img class="img_size2" src="<?php echo themes_url("images/category/wedding.png"); ?>" />
			<br />
