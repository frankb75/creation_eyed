...
<div style="margin:0 auto; width:91%; overflow:hidden;">

<p>1. Click on an image to select (green border denotes selection)<br/>
2. Enter the quantity for each print size in the appropriate box<br/>
3. Select next image, and repeat<br/>
4. When finished, click Add to Cart<br/>
</p>
<p>NOTE: An image that is displayed only in B&W cannot be ordered as a color print.</p>
...
<div style="overflow:hidden; margin-top:15px;">
	...
	<div style="margin:0 auto; width:91%; overflow:hidden; color:#646468; font-size:18px;">
...
<div style="overflow:hidden; margin-top:5px;">
	...
	<div style="margin:0 auto; width:91%; overflow:hidden; background:#404040; padding:8px 0; color:#ffffff;">
...
<div style="overflow:hidden; margin-top:20px;">
	...
	<div style="margin:0 auto; font-family:Helvetica; width:91%; overflow:hidden;">
			...
			<div class="nano" style="height:<?php echo $nano; ?>;">
				...
				<div class="nano-content" style="color:#646468; height:<?php echo $nano; ?>; overflow-y:scroll;">
					...
					<?php
						...
						$q = $this->QModel->sfwa('clients_photos','clients_photos_id',$clients_photos_id);
					...
					<div id="img<?php echo $i; ?>" style="cursor:pointer; width:300px; overflow:hidden; background:#ffffff; height:300px; border:5px solid <?php echo $border; ?>; margin:0 auto;" onclick="selectingImage(<?php echo $i; ?>)">
						...
						<div style="overflow:hidden; padding:15px;">
							...
							<div style="height:240px; overflow:hidden;">
								...
								<img id="image<?php echo $clients_photos_id; ?>" src="<?php echo base_url("uploads/gallery/clients/".$clients_id."/original/".$original_image); ?>" style="display:block;" width="100%" height="250"/>
					...
					<div style="width:300px; margin:0 auto;">
						...
						<button id="viewBNW<?php echo $clients_photos_id; ?>" style="margin-top:5px; font-size:14px; border-radius:5px; padding:3px 8px; cursor:pointer; margin-bottom:15px;" onclick="blackAndWhite(1,<?php echo $clients_photos_id; ?>)">View in Black and White</button>
		...
		<form method="POST">
			...
			<div class="payment_proccess" style="float:right; width:54%; overflow:hidden;">
				...
				<?php
					...
					$clients_photos_id = $gright['clients_photos_id'];
				...
				<?php 
					...
					$query = $this->QModel->sf('delivery_setup');
...

					{
						...
						$query2 = $this->QModel->sfwa('cart',array('session_id','delivery_setup_id','color','clients_photos_id'),array($this->session->userdata('isCart'),$delivery_setup_id,'Color',$clients_photos_id));
						...
						$query3 = $this->QModel->sfwa('cart',array('session_id','delivery_setup_id','color','clients_photos_id'),array($this->session->userdata('isCart'),$delivery_setup_id,'B&W',$clients_photos_id));
				...
				<tr>
					...
					<td style="text-align:center;"><input type="text" name="color<?php echo $ii; ?>[<?php echo $delivery_setup_id; ?>]" value="<?php echo $this->input->post('color'.$ii,FALSE,FALSE)[$delivery_setup_id]; ?>" style="width:60px; margin-top:5px; padding:3px;"/></td>
					...
					<td style="text-align:center;"><input type="text" name="bw<?php echo $ii; ?>[<?php echo $delivery_setup_id; ?>]" value="<?php echo $this->input->post('bw'.$ii,FALSE,FALSE)[$delivery_setup_id]; ?>" style="width:60px; margin-top:5px; padding:3px;"/></td>
