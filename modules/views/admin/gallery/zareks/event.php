...
<?php get_header("admin/header",array('admin_bodycss','adminClient')); ?>
	...
	<?php echo $this->session->userdata('success'); ?>
		...
		<?php
			$i = 0;
			$query = $this->QModel->sf('zareks','date_client DESC');
		...
		<tr class="tbl_body">
			...
			<td>
				<a href="<?php echo base_url('admin/zareks_edit_event/'.$get['zareks_id']); ?>">Edit</a> | 
				<a href="<?php echo base_url('admin/zareks_delete_event/'.$get['zareks_id']); ?>">Delete</a>
			</td>
		</tr>
		<?php else: $i = 0; ?>
		<tr class="tbl_body2">
