...
<?php get_header("admin/header",array('admin_bodycss','adminClient','ce_alert','cc_box')); ?>
	<div style="background:#c6c7cb; overflow:hidden; padding-top:23px;">
		<a class="unselected-menu" href="<?php echo base_url('admin/zareks'); ?>" style="margin-left:20px;">Print Prices</a>
		<a class="unselected-menu" href="<?php echo base_url('admin/zareks_create_event'); ?>">Create Event</a>
		<a class="unselected-menu" href="<?php echo base_url('admin/zareks_event'); ?>">Events</a>
		<a class="selected-menu" href="<?php echo base_url('admin/zareks_shipping_cost'); ?>">Shipping Cost</a>
	</div>
	<div style="padding:20px; overflow:hidden;">
		...
		<form method="POST">
			...
			<tr class="tbl_body">
				...
				<td style="text-align:center;"><a href="<?php echo base_url('admin/zareks_shipping_cost_edit/'.$get['shipping_cost_id']); ?>">Edit</a></td>
			</tr>
			<?php else: $i = 0; ?>
			<tr class="tbl_body2">
				<td>&nbsp; <?php echo $get['shipping_cost']; ?></td>
