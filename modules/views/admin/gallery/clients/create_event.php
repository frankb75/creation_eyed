...
<?php get_header("admin/header",array('admin_bodycss','adminClient','datepicker')); ?>
	<div style="background:#c6c7cb; overflow:hidden; padding-top:23px;">
		<a class="selected-menu" href="<?php echo base_url('admin/create_event'); ?>" style="margin-left:20px;">Create Event</a>
	...
	<div style="padding:20px; overflow:hidden;">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<tr>
				<td>Password:</td>
				<td><input class="input_text" type="password" name="password" value="<?php echo isset($password) ? $password : ""; ?>"/></td>
			</tr>
			<tr>
