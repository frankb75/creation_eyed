...
<div style="margin:0 auto; width:85%; overflow:hidden;display:none;">
	...
	<div style="margin:0 auto; width:85%; overflow:hidden; color:#ffffff;">
		...
		<table style="width:100%;font-family:Helvetica;">
			...
			<tr>
				...
				<td colspan="6" style="text-align:center; color:#000">No Records found!</td>
			...
			<tr>
						...
						<div style="overflow:hidden; padding:5px;">
							...
							<div style="height:134px; width:124px; text-align:center; overflow:hidden;">
								...
								<?php if($get['color'] == "Color"): ?>
									...
									<img src="<?php echo base_url('uploads/gallery/clients/'.$get2['clients_id'].'/semi-original/'.$get2['semi_original_image']); ?>" style="margin:0 auto; width:124px;"/>

								<?php else: ?>

									<img class="blackandwhite" src="<?php echo base_url('uploads/gallery/clients/'.$get2['clients_id'].'/semi-original/'.$get2['semi_original_image']); ?>" style="margin:0 auto; width:124px;"/>
				...
				<td style="vertical-align:top; padding:15px 0; padding-left:30px;">
					...
					<form action="<?php echo base_url('gallery/clients_gallery_view_addtocart/'.$get['cart_id'].'?r='.$this->input->get('r')); ?>" method="POST">
						...
						<input style="margin-top:10px; font-size:90%; border-radius:5px; cursor:pointer; text-align:center; width:87px;" type="submit" name="return" value="More Size" onclick="location.href = '<?php echo base_url('gallery/clients_gallery_image_purchase/'.$get2['clients_id'].'/'.$get['clients_photos_id'].'?r='.$this->input->get('r')); ?>'; return false;"/>

					</form>

					<?php if($get['clients_photos_id']): ?>
						...
						<div style="overflow:hidden; margin-top:30px;">
							...
							<?php
								...
								if($this->input->get('r'))
									...
									$return_url = base_url('gallery/clients_gallery_view/'.$this->input->get('r'));

								else

									$return_url = base_url('gallery/clients');
