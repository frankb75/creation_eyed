...
<div style="overflow:hidden; margin-top:20px;">
	...
	<div style="margin:0 auto; font-family:Helvetica; width:85%; overflow:hidden;">
		...
		<div style="float:left; width:41%;">
			...
			<div style="width:100%; overflow:hidden; background:#ffffff; height:400px;">
				...
				<div style="overflow:hidden; padding:15px;">
					...
					<div style="height:340px; overflow:hidden;">
						...
						<a href="javascript:void(0);" onclick="alert('Image will pop up');"><img id="image" src="<?php echo base_url("uploads/gallery/clients/".$clients_id."/original/".$original_image); ?>" style="display:block;" width="375" height="340"/></a>
			...
			<p style="color:#646468; margin-top:8px;">NOTE:x An image that is displayed only in B&W cannot be ordered as a color print.</p>
			...
			<form method="POST">
				...
				<tr>
					...
					<?php
						...
						if($this->input->post('color',FALSE,FALSE)[$delivery_setup_id]):

					?>

					<td style="text-align:center;"><input type="text" name="color[<?php echo $delivery_setup_id; ?>]" value="<?php echo $this->input->post('color',FALSE,FALSE)[$delivery_setup_id]; ?>" style="width:60px; margin-top:5px; padding:3px;"/></td>
					...
					<?php
						...
						if($this->input->post('bw',FALSE,FALSE)[$delivery_setup_id]):

					?>

					<td style="text-align:center;"><input type="text" name="bw[<?php echo $delivery_setup_id; ?>]" value="<?php echo $this->input->post('bw',FALSE,FALSE)[$delivery_setup_id]; ?>" style="width:60px; margin-top:5px; padding:3px;"/></td>
