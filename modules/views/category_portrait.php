...
<div style="margin-left:auto; font-family:Helvetica; margin-right:auto; width:80%; padding-left:50px; overflow:hidden;">
	<?php $query = $this->QModel->query("SELECT * FROM portraits_photos WHERE category='".$categ."' ORDER BY photos_id ASC"); ?>
	<?php if($type == "family"): ?>
		<?php
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="family<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					...
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=family'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('portraits/category?type=family'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("family<?php echo $i; ?>");
				...
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/portraits/family/original/'.$photos); ?>" rel="lightbox[family]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/portraits/family/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
	...
	<?php elseif($type == "individual"): ?>
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="individual<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					<form name="uploading<?php echo $i; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
						<input id="u<?php echo $i; ?>" type="file" name="upload" style="width:200px; opacity:0"/>
					</form>
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=individual'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('portraits/category?type=individual'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("individual<?php echo $i; ?>");
						wed<?php echo $i; ?>.onclick = function(event) {
							document.uploading<?php echo $i; ?>.upload.click(event);
						};
					</script>
				...
				<?php endif; ?>
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/portraits/individual/original/'.$photos); ?>" rel="lightbox[individual]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/portraits/individual/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
	...
	<?php elseif($type == "children"): ?>
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="children<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					<form name="uploading<?php echo $i; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
						<input id="u<?php echo $i; ?>" type="file" name="upload" style="width:200px; opacity:0"/>
					</form>
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=children'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('portraits/category?type=children'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("children<?php echo $i; ?>");
						wed<?php echo $i; ?>.onclick = function(event) {
							document.uploading<?php echo $i; ?>.upload.click(event);
						};
					</script>
				...
				<?php endif; ?>
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/portraits/children/original/'.$photos); ?>" rel="lightbox[children]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/portraits/children/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
			...
			?>
		<?php endif; ?>
	<?php elseif($type == "pregnancy_boudoir"): ?>
		<?php
			if( ! $this->QModel->c($query)):
		?>
			<div style="width:100%;color:#646468;font-size:18px;text-align:center;">
		...
		<?php else: ?>
			...
			<div style="float:left; margin-bottom:7px; width:32%; margin-left:7px;">
				<?php if($this->session->userdata('admin')): ?>
					<span id="pregnancy_boudoir<?php echo $i; ?>" style="color:#646468; font-size:16px; cursor:pointer;">Edit</span>	
					<form name="uploading<?php echo $i; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
						<input id="u<?php echo $i; ?>" type="file" name="upload" style="width:200px; opacity:0"/>
					</form>
					<script>
						document.querySelector('#u<?php echo $i; ?>').addEventListener('change', function(e) {
							uploadFiles('<?php echo base_url('admin/reupload/'.$photos_id.'?type=pregnancy_boudoir'); ?>',this.files,'uploading<?php echo $i; ?>','<?php echo base_url('portraits/category?type=pregnancy_boudoir'); ?>');
						}, false);
						
						var wed<?php echo $i; ?> = document.getElementById("pregnancy_boudoir<?php echo $i; ?>");
						wed<?php echo $i; ?>.onclick = function(event) {
							document.uploading<?php echo $i; ?>.upload.click(event);
						};
					</script>
				...
				<?php endif; ?>
				<div id="drop<?php echo $photos_id; ?>" ondrop="drop(event)" ondragover="allowDrop(event)">
					<a id="a|drag<?php echo $photos_id; ?>" draggable="true" ondragstart="drag(event)" href="<?php echo base_url('uploads/portraits/pregnancy_boudair/original/'.$photos); ?>" rel="lightbox[pregnancy_boudoir]">
						<div id="xd<?php echo $i; ?>" style="height:270px; width:100%; background:#e2e2e2; text-align:center; overflow:hidden;">
							<div id="xdx<?php echo $i; ?>" style="height:270px; width:100%; display:table-cell; vertical-align:middle; text-align:center;">
								<img id="drag<?php echo $get['photos_id']; ?>" src="<?php echo base_url("uploads/portraits/pregnancy_boudair/semi-original/".$photos); ?>" style="margin:0 auto;"/>
							</div>
						</div>
					</a>
				</div>
